...
export async function allPokemons(){
    const resApiPokemon = await fetch('https://pokebuildapi.fr/api/v1/pokemon/limit/10')
    const pokemons100 = await resApiPokemon.json()
    console.log('pokemons100', pokemons100)
    return pokemons100
